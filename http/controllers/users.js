    ...
    console.log("true-----", Object.keys(reqUser).length === 0);
        process.nextTick(() => {
            if (Object.keys(reqUser).length === 0) {
                ...
                let content = {
                    success: false,
                    message: 'Username is not valid. It should be between 4 and 45 characters long.'
                };
                res.send(content);
                return;
            }
                ...
                let content = {
                    success: false,
                    message: 'Password is not valid. It should be between 6 and 60 characters long.'
                };
                res.send(content);
                return;
            }
                ...
                let content = {
                    success: false,
                    message: 'Country, city, school and university is required.'
                };
                res.send(content);
                return;
            }
                ...
                let content = {
                    success: false,
                    message: 'Date of your birthday is not valid.'
                };
                res.send(content);
                return;
            }
